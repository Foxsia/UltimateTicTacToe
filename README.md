...
Instead of playing on a single 3×3 board, the game consists of nine smaller Tic-Tac-Toe boards arranged in a 3×3 grid.

Each move determines which board the opponent has to play on next, creating an additional layer of strategy compared to traditional Tic-Tac-Toe.
...
9 interconnected 3×3 boards

Turn-based gameplay

Designed for the BlackBerry Boy handheld console
...
The goal of the project is to build both the hardware and software needed for a small platform capable of running multiple games.
